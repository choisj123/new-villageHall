    ...
    <main>
      ...
      <section class="body">
        ...
        <section class="right-body">
          <h2>
            <a
              href="${contextPath}/board/popularBoard?sortBy=like"
              style="text-decoration: none; color: black; padding-left: 30px"
              >인기게시판</a
            >
          </h2>
          ...
          <form id="sortBy">
            ...
            >
              <option value="like" <% if(sortBy.equals("like")) { %> selected <%
              } %>>좋아요순 <option value="read" <% if(sortBy.equals("read")) {
              %> selected <% } %>>조회수순
            </select>
          </form>
                      ...
                      <tr>
                        ...
                        <c:choose>
                          <c:when test="${board.commentCount > 0}">
                            <td>
                              <a
                                href="${contextPath}/board/boardDetail?boardNo=${board.boardNo}"
                                >${board.boardTitle}<span
                                  style="color: #55710f"
                                >
                                  [${board.commentCount}]</span
                                ></a
                              >
                            </td>
                          </c:when>
